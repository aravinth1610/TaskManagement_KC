package com.unicore.securityConstant;
...
//	
//	String ESECURITYUSER = "ESECURITYUSER";
	
	String EMAIL_PATTERN = "^[\\w!#$%&’*+/=?`{|}~^-]+(?:\\.[\\w!#$%&’*+/=?`{|}~^-]+)*@(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,6}$";
//	String AUTHORIZATIONCODE = "AuthorizationCode";
//	String CLIENTCREDENTIAL = "ClientCredential";
//	String PASSWORD = "Password";
	
//	String TOKENISSUER = "AUTHKEY";
